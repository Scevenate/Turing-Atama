  ...
  return (
    <>
      ...
      <div className="fixed w-screen h-screen flex flex-row justify-center overflow-scroll bg-transparent">
        <div className="flex flex-col items-center h-min md:w-2/3 md:px-20 p-10 md:border-x-2 md:border-border mx-auto bg-[rgba(30,30,30,0.5)]">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 330 100" width="132" height="40" className="hover:-translate-y-0.5 transition-transform" onClick={() => { setInitial(); void navigate('/level/1'); }}>
           <path d="M 0 0 H 250 L 300 50 L 250 100 H 0 Z" stroke="#3e3e42" strokeWidth={3} fill="#0078d4" className="fill-accent-accent hover:fill-accent-2 cursor-pointer"></path>
           <text x="30" y="70" fontSize="50" fill="#cccccc" className="pointer-events-none">Continue</text>
          </svg>
        </div>
      </div>
    </>
